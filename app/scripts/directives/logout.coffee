  ...
  .directive('logoutButton', (AuthorizationService) ->
    {
      restrict: 'E'
      replace: false
      template: '<span><a href="/" title="Sign Out"><i class="fa fa-sign-out"></i></a></span>'
      controllerAs: 'ctrl2'
      controller: ($scope, $element, $attrs) ->
        $scope.$on('auth:validation-success', -> console.log('Validation success'))
            ...
            angular.element.SmartMessageBox(
              {
                ...
                title: "<i class='fa fa-sign-out txt-color-orangeDark'></i> Logout <span class='txt-color-orangeDark'><strong> UNDEFINED </strong></span> ?"
